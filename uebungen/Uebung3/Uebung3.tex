...
$+ P[M_B^{|x\rangle,|y\rangle}(|\langle \alpha|0\rangle|^2~|\alpha\rangle + |\langle \beta|0\rangle|^2~|\beta\rangle)=|x\rangle] + P[M_B^{|x\rangle,|y\rangle}(|\langle \alpha|x\rangle|^2~|\alpha\rangle + |\langle \beta|x\rangle|^2~|\beta\rangle)=|x\rangle])$\\
