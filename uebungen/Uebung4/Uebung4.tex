...
$=\prod_{i=1}^{n-1} Pr[$Vektoren $y_1$ bis $y_i$ sind l.u$]$\\
$=\prod_{i=0}^{n-2} Pr[y_{i+1}$ ist l.u. von $y_1$ bis $y_i \wedge y_{i+1}\neq 0^n]$\\
$=\prod_{i=0}^{n-2} Pr[y_{i+1} \notin \{y_1,..,y_i\} \wedge y_{i+1}\neq 0^n \wedge y_{i+1}$ ist nicht Summe zweier oder mehr ungleicher Summanden aus $\{y_1,..,y_i\}]$\\
